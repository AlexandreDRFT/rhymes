...
class SocketConnection extends Queue_1.Queue {
    ...
    connect() {
        this.WebSocket = new WebSocketWrapper_1.WebSocketWrapper('wss://' + this.XAPI.hostName + '/' + this.XAPI.accountType);
    ...
    setConnectionStatus(status) {
        ...
        if (status === Enum_1.ConnectionStatus.CONNECTING) {
            this.pingTimeout.setTimeout(() => {
                this.ping().catch(e => {
                    Log_1.Log.error('Socket: ping request failed (SocketConnection.ts:63)');
                });
            }, 100);

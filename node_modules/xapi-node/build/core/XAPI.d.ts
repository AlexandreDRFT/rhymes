...
import { ConnectionStatus, PERIOD_FIELD, Time } from '..';
...
export declare class XAPI extends Listener {
    ...
    onReady(callBack: () => void, key?: string | null): void;
    onReject(callBack: (err: any) => void, key?: string | null): void;
    onConnectionChange(callBack: (status: ConnectionStatus) => void, key?: string | null): void;
    onCreatePosition(callBack: (position: TradePosition) => void, key?: string | null): void;
    onDeletePosition(callBack: (position: TradePosition) => void, key?: string | null): void;
    onChangePosition(callBack: (position: TradePosition) => void, key?: string | null): void;
    onPendingPosition(callBack: (position: TradePosition) => void, key?: string | null): void;
}

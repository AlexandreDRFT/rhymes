...
export declare class Stream extends StreamConnection {
    ...
    listen: {
        getBalance: (callBack: (data: STREAMING_BALANCE_RECORD, time: Time) => void, key?: string | null) => void;
        getCandles: (callBack: (data: STREAMING_CANDLE_RECORD, time: Time) => void, key?: string | null) => void;
        getKeepAlive: (callBack: (data: STREAMING_KEEP_ALIVE_RECORD, time: Time) => void, key?: string | null) => void;
        getNews: (callBack: (data: STREAMING_NEWS_RECORD, time: Time) => void, key?: string | null) => void;
        getProfits: (callBack: (data: STREAMING_PROFIT_RECORD, time: Time) => void, key?: string | null) => void;
        getTickPrices: (callBack: (data: STREAMING_TICK_RECORD, time: Time) => void, key?: string | null) => void;
        getTrades: (callBack: (data: STREAMING_TRADE_RECORD, time: Time) => void, key?: string | null) => void;
        getTradeStatus: (callBack: (data: STREAMING_TRADE_STATUS_RECORD, time: Time) => void, key?: string | null) => void;
    };
    subscribe: {

...
class StreamConnection extends Queue_1.Queue {
    ...
    connect() {
        this.WebSocket = new WebSocketWrapper_1.WebSocketWrapper('wss://' + this.XAPI.hostName + '/' + this.XAPI.accountType + 'Stream');
    ...
    sendCommand(command, completion = {}, urgent = false) {
        return new Promise((resolve, reject) => {
            const transaction = this.addTransaction({
                command,
                json: JSON.stringify(Object.assign(Object.assign({}, completion), { command, 'streamSessionId': this.session })),
                args: completion,
